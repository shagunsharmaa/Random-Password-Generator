...
# the password contains only 4 characters but we want a 12-character password
...
for x in range(MAX_LEN - 4):
    ...
    # convert temporary password into array and shuffle to prevent it from having
    # a consistent pattern where the beginning of the password is predictable
